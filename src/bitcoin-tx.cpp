...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mbzcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mbzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mbzcoin transaction") + "\n" +
              "  mbzcoin-tx [options] -create [commands]   " + _("Create hex-encoded mbzcoin transaction") + "\n" +
              "\n";
