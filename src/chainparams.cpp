...
{
    const char* pszTimestamp = "BBC NEWS 19/07/2020 Colombia tierra querida.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1595192185, 4117650319, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3ced42d741172dfa517a9ed97aa2e3c7d44027320506a309777ef596120451b3"));
        assert(genesis.hashMerkleRoot == uint256S("0xd141829d2a95734faea26842023069678b69a556306ac8cd35093bb623816a8e"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.mbzcoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.mbzcointools.com");
        // vSeeds.emplace_back("dnsseed.mbzcoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x41, 0x89, 0xB3, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x41, 0x89, 0xAE, 0xE4};
        ...
        checkpointData = {
            {
                {  0, uint256S("0x3ced42d741172dfa517a9ed97aa2e3c7d44027320506a309777ef596120451b3")},
                /*
        ...
        chainTxData = ChainTxData{
            ...
            1595192185, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1595191678, 4118204921, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa44bdf5a83c8020098b7b703939b8ef31371f9f707238e9030c2e1e42dd4c06c"));
        assert(genesis.hashMerkleRoot == uint256S("0xd141829d2a95734faea26842023069678b69a556306ac8cd35093bb623816a8e"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        // vSeeds.emplace_back("testnet-seed.mbzcointools.com");
        // vSeeds.emplace_back("seed-b.mbzcoin.loshan.co.uk");
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0xa44bdf5a83c8020098b7b703939b8ef31371f9f707238e9030c2e1e42dd4c06c")},
            }
        };
