...
const char * const BITCOIN_CONF_FILENAME = "mbzcoin.conf";
const char * const BITCOIN_PID_FILENAME = "mbzcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MBZCOIN";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MBZCOIN";
#else
    // Unix
    return pathRet / ".mbzcoin";
#endif
#endif
}
