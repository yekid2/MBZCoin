...
* mbzcoin.conf: contains configuration settings for mbzcoind or mbzcoin-qt
* mbzcoind.pid: stores the process id of mbzcoind while running
...
* debug.log: contains debug information and general logging generated by mbzcoind or mbzcoin-qt
